...
public:
    ...
    QSlider *verticalSliderMaxLayer;
    ...
    QSlider *verticalSliderMinLayer;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalSliderMaxLayer = new QSlider(centralWidget);
        verticalSliderMaxLayer->setObjectName(QString::fromUtf8("verticalSliderMaxLayer"));
        verticalSliderMaxLayer->setOrientation(Qt::Vertical);

        gridLayout->addWidget(verticalSliderMaxLayer, 0, 8, 1, 1);
        ...
        verticalSliderMinLayer = new QSlider(centralWidget);
        verticalSliderMinLayer->setObjectName(QString::fromUtf8("verticalSliderMinLayer"));
        verticalSliderMinLayer->setOrientation(Qt::Vertical);

        gridLayout->addWidget(verticalSliderMinLayer, 0, 7, 1, 1);
        ...
        verticalSliderHeight = new QSlider(centralWidget);
        verticalSliderHeight->setObjectName(QString::fromUtf8("verticalSliderHeight"));
        verticalSliderHeight->setOrientation(Qt::Vertical);

        gridLayout->addWidget(verticalSliderHeight, 0, 9, 1, 1);
