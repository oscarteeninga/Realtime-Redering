...
private slots:
    ...
    void on_verticalSliderMinLayer_valueChanged(int value);

    void on_verticalSliderMaxLayer_valueChanged(int value);

    void on_verticalSliderHeight_valueChanged(int value);
