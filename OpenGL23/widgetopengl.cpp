...
#define TEXTURE "bricks"    //  wood bricks stones stones2 stones3 bricks2
...
void WidgetOpenGL::paintGL()
{
    ...
    try
    {
        ...
        glUniform1f(attr_paralax, minLayers);
        attr_paralax = getUniformLocation(shaderProgram, "maxLayers");
        glUniform1f(attr_paralax, maxLayers);
        attr_paralax = getUniformLocation(shaderProgram, "heightScale");
        glUniform1f(attr_paralax, 1.0 * heightScale/5000);
...
void WidgetOpenGL::sliderMinLayer_valueChanged(int value)
{
    minLayers = value;
...
void WidgetOpenGL::sliderMaxLayer_valueChanged(int value)
{
    maxLayers = value;
    repaint();
}

void WidgetOpenGL::sliderHeight_valueChanged(int value)
{
    heightScale = value;
    repaint();
}
